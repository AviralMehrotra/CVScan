        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Empowering job seekers with AI-driven resume analysis to beat the
              ATS and land their dream roles.
            </p>
            <div className="flex gap-4 mt-2">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-orange-500 hover:text-orange-500 transition-all shadow-sm"
              >
